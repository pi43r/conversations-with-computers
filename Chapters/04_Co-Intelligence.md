...
We concluded that the brain must do the thinking[^3] and using the scientific method the brain was separated into smaller parts until synapses and neurons were defined and described. But the physical functioning of the brain does not explain the emotional experience of the self. 
...
In order to understand human cognition and intelligence, we need to explore the dialogic connections between human and non-human actors. Current machine learning programs abstract intelligence into simplified task solving mechanisms and make us believe that the underlying algorithm becomes a rational agent. But on a closer look the program reveals an astonishing amount of human collaboration: from the creation of programming languages, digital computing and ultimately the internet to the enormous amounts of data aggregation and labeling. Instead of looking at AI systems and seeing them as a subjective entity, we can also see them as artifacts of collective intelligence.  
...
[^5]: The simulation argument was first proposed by Nick Bostrom, where he argues that if we were able to create simulated brains and worlds in the future, it is likely that we already live in a simulation. [@bostromAreYouLiving2001]
