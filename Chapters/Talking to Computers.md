...
Before weighted networks were used, the error rate of automated speech recognition went from 40% in the 1990s down to 15% in the 2000s, which was still very high, but became practical to use.  

But there is another, more ethical, way than stealing people’s speech: The Mozilla Foundation's *Commonvoice* project relies on people voluntarily recording their voices for computer models, and the resulting speech recognition and synthesis software can be offered with an open source license.[^12]
...
The analogy of talking to dolls
...
[^12]: Link:[ https://commonvoice.mozilla.org/de](https://commonvoice.mozilla.org/de)

[^13]: The title “I’d blush if I could” is also the response Siri gives to the insult “You’re a bitch”

[^14]: Nadine Alessio’s project website. Link:[ http://nadinelessio.com/projects.html](http://nadinelessio.com/projects.html)
